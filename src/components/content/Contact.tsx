                  ...
                  <ul>
                    <li>
                      <p>
                        <label>Email:</label>
                        <span>
                          <a href="mailto:minhthuanngo0907@gmail.com">
                            minhthuanngo0907@gmail.com
                          </a>
                        </span>
                      </p>
                    </li>
                    <li>
                      <p>
                        ...
                        <span>
                          <a
                            href="https://github.com/Thuan0907/cv-typescript"
                            target="_blank"
                          >
                            https://github.com/Thuan0907/cv-typescript
                          </a>
                        </span>
                      </p>
                    </li>
